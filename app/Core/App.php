...
final class App
{
    ...
    public function run(): void
    {
        ...
        $routes = [
            ...
            'clients.show' => [ClientController::class, 'show'],
            'clients.store' => [ClientController::class, 'store'],
            'clients.resend-welcome' => [ClientController::class, 'resendWelcomeEmail'],
            'clients.send-reset-email' => [ClientController::class, 'sendPasswordResetEmail'],
            ...
            'employees.delete' => [EmployeeController::class, 'delete'],
            ...
            'reports.download' => [WorkspaceController::class, 'downloadReport'],
