    ...
    <?php foreach ($employees as $employee): ?>
        <article class="entity-card">
            ...
            <div class="entity-actions">
                <a class="btn btn-secondary" href="<?= htmlspecialchars($config['app']['base_url']) ?>/index.php?route=assignments">View</a>
                <a class="btn btn-secondary" href="#employee-form">Edit</a>
            </div>
        </article>
    <?php endforeach; ?>
</section>
...
<section class="card form-card" id="employee-form">
    <div class="card-head">
        <div>
            <h3>Add Employee</h3>
            <p>Create a new agency employee account.</p>
        </div>
    </div>
